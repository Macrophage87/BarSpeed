...
- Exercise: {"exercise": snake_case_id, "notes": optional coaching cue shown to me in-app, "sets": [...]} plus these optional keys:
  ...
  "prep_s": integer seconds — how long I need between tapping START and the voice guide calling the first rep. Estimate THE TIME MY HANDS ARE UNAVAILABLE: fastening straps, chalking, setting a hook grip, cinching a belt, lying down on a machine — not walking to the rack or loading plates, which I do before starting the set. A Romanian deadlift with straps is not ready five seconds after I tap START; a cable machine is ready in two. 0 to 120. ONLY APPLIES TO SETS WITH A tempo, since a set with no tempo runs no voice guide. Omitted means 5. I can change it in the app and the change comes back in my export as prep_s beside plannedPrep_s — read that rather than guessing again.
